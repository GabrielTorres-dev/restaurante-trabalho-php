...
<body>
    <header>
        <img src="../imagens/logo_burgues_laranja_2 (1).png" alt="Logo Burgues ">
        <div class="cardapio-boasvindas">
            
            <h1>Seja Bem-Vindo ao nosso cardápio!</h1>
        </div>
    </header> 
    <section id="cardapio">
    <div id="corpo">
        <div id="hamburguer">
            <img id="foto" src="../imagens/456881261_1724569375019748_4628731805975508229_n.jpg"  alt="American Chicken">
            <h3>American Chicken</h3>
            <p>Frango Empanado, Queijo Mussarela, Alface Americana, Picles de Pepino, Molho a sua escolha e Tudo isso no pão brioche</p>
            <strong>R$ 29,90</strong>
        </div>

        <div id="hamburguer">
            <img id="foto" src="../imagens/457018579_519335344006953_2579318147507496788_n.jpg" alt="Burger Clássico">
            <h3>Clássico</h3>
        ...
        <div id="hamburguer">
            <img id="foto" src="../imagens/457257238_865974362133289_2550781275651349189_n.jpg" alt="Costela Creamy">
            <h3>Costela Creamy</h3>
            <p>Blend de 180g de Costela, Cream cheese, Alho Crocante, Cebola no shoyu, Mollho a sua escolha,Tudo montado no pão brioche</p>
            <strong>R$ 31,90</strong>
        </div>

        <div id="hamburguer">
            <img id="foto" src="../imagens/457022564_485837667570122_1376005797323809782_n.jpg" alt="Costela Angus">
            <h3>Costela Angus</h3>
        ...
        <div id="hamburguer">
            <img id="foto" src="../imagens/457281214_1243798510113364_8484507634713217653_n.jpg" alt="Cheese crispy">
            <h3>Cheese crispy</h3>
        ...
        <div id="hamburguer">
            <img id="foto" src="../imagens/457132184_8125801310792444_2026918450704921741_n.jpg" alt="Frango Cream Cheese">
         ...
         <div id="hamburguer">
            <img id="foto" src="../imagens/456443230_724541109823734_6029369618997251756_n.jpg" alt="Americano">
            <h3>Americano</h3>
         ...
         <div id="hamburguer">
            <img id="foto" src="../imagens/456559587_1176813483607529_5187894326773792844_n.jpg" alt="Costela Gorgonzola">
         ...
         <div id="hamburguer">
            <img id="foto" src="../imagens/456879902_483612124457922_5731631353008052517_n.jpg" alt="Gran Tradicional">
         ...
         <div id="hamburguer">
            <img id="foto" src="../imagens/457126883_1719121988626404_5180914323847251039_n.jpg" alt="Veggie" >
            <h3>Veggie</h3>
    ...
    <!-- Bebidas -->
<h2 style="color: #E65100">Bebidas:</h2>
<div id="corpo">
    <div id="hamburguer">
        <img id="foto" src="../imagens/refrigerante-lata.jpg" alt="Coca-Cola Lata">
        <h3>Coca-Cola Lata</h3>
        <p>Geladinha pra acompanhar seu burguer favorito.</p>
        <strong>R$ 6,00</strong>
    </div>
    <div id="hamburguer">
        <img id="foto" src="../imagens/guarana.jpg" alt="Guaraná Antarctica Lata">
        <h3>Guaraná Antarctica</h3>
        <p>O clássico brasileiro que não pode faltar.</p>
        <strong>R$ 6,00</strong>
    </div>
    <div id="hamburguer">
        <img id="foto" src="../imagens/350036---Bebida-Energetica-Red-Bull-355ml-1.webp" alt="Redbull">
        <h3>Red bull</h3>
...
<!--Acompanhamentos -->
<h2 style=" color: #E65100">Acompanhamentos:</h2>
<div id="corpo">
    <div id="hamburguer">
        <img id="foto" src="../imagens/622291-batata-airfryer-extra-croc-mccain_3.webp" alt="Batata Frita">
        <h3>Batata Frita</h3>
        <p>Porção média de batata frita crocante com sal.</p>
        <strong>R$ 24,00</strong>
    </div>
    <div id="hamburguer">
        <img id="foto" src="../imagens/5d2cb094b44ce72d3e3baa89.webp" alt="Onion Rings">
        <h3>Onion Rings</h3>
        <p>Anéis de cebola empanados e crocantes.</p>
        <strong>R$ 27,00</strong>
    </div>
    <div id="hamburguer">
        <img id="foto" src="../imagens/mandioca-frita.jpg" alt="Mandioca">
...
<div>
    ...
    <footer>
        ...
        <hr>
        <p id="footer"></p>
        <p><h5>Sujeito à disponibilidade em estoque. Imagens meramente ilustrativas.</h5></p>
</footer>
</body>
</html>